<nav class="navbar change navbar-expand-lg">
    <div class="container-fluid">
        <div class="row w-100 justify-content-center align-items-center">
            <div class="d-none d-md-none d-lg-block col-md-2 col-lg-2">
                <!-- Logo -->
                <a class="logo" href="/">
            ...
            <div class="col-5 d-block d-md-block d-lg-none align-items-center" style="bottom: 13px;">
                <div class="social-icon d-flex">
                    ...
                    <a href="https://instagram.com/nalmiadevelopment?igshid=OGQ5ZDc2ODk2ZA==" target="_blank" style="border: 1px solid #d8c6b0"><i style="color: #d8c6b0;"
            ...
            <div class="col-12 col-md-12 col-lg-4 text-center" id="menu-items" style="left: 1rem;">
                <!-- navbar links -->
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="d-block d-md-none">
                            <a href="?lang=es"><img style="width: 1.5rem;" src="/img/esp.png" alt=""></a>
                            <a href="?lang=en"><img style="width: 1.5rem;" src="/img/eng.png" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
