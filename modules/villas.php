    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-1 col-md-8 mb-30">
                <div class="text">
                    <p>
                        Nalmia Villas cuenta con una ubicación excepcional, a solo unos pasos de la playa, en el corazón
                        de Los Barriles. A una cuadra de la calle principal, donde encontrarás restaurantes, tiendas de
