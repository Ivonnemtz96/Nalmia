    ...
    for (var c = ma(a.j()), d = 0; d < c.length; d++) {
      ...
      if (null != b.g[e]) {
        ...
        if (f.m) {
          ...
          (f = u(b, e)),
            g ? ((g = u(a, e)) ? na(g, f) : q(a, e, f.clone())) : q(a, e, f);
      }
    }
  }
...
*/
  ...
  function Ra(a, b, c, d) {
    ...
    null == h
      ...
      : 0 === h.length
      ? (g = !1)
      : ((g = Ca.exec(h)), (h = Da.exec(h)), (g = null !== g || null !== h));
    if (!g)
      throw Error("The string supplied did not seem to be a phone number");
    null != e
      ? ("+" === e.charAt(0) && f.g(e),
        (e = b.indexOf("tel:")),
        f.g(b.substring(0 <= e ? e + 4 : 0, b.indexOf(";phone-context="))))
      : ((e = f.g),
        (g = b ?? ""),
        (h = g.search(ya)),
        0 <= h
    ...
    try {
      ...
      if ("Invalid country calling code" == G.message && K.test(l)) {
        if (((l = l.replace(K, "")), (h = Pa(a, l, g, b, d, e)), 0 == h))
          throw G;
      } else throw G;
    }
    0 != h
    ...
    null != g &&
      ...
      2 != a &&
        4 != a &&
        5 != a &&
        ((b = f), d && 0 < c.toString().length && q(e, 7, c.toString())));
    d = b.toString();
    a = d.length;
    if (2 > a)
      throw Error("The string supplied is too short to be a phone number");
